...
public class PnzDataDao {
     ...
     * @param sumU
     */
    public String addPnzData(Pnz pnz, Date pnzDateTime, Double bsh, Double ds, Double sr, Double ou, Double do_, Double oa, Double ozon, Double serovodorod, Double fenol, Double fv, Double hlor, Double hv, Double ammiak, Double skIs, Double formaldigid, Double nsm, Double hromSh, Double sumU) {
     ...
     * @param sumU
     */
    public String updatePnzData(int pnzDataId, Pnz pnz, Date pnzDateTime, Double bsh, Double ds, Double sr, Double ou, Double do_, Double oa, Double ozon, Double serovodorod, Double fenol, Double fv, Double hlor, Double hv, Double ammiak, Double skIs, Double formaldigid, Double nsm, Double hromSh, Double sumU) {
        Session session = HibernateUtil.getSessionFactory().openSession();
        Transaction tx = null;
