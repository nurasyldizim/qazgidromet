    ...
    <header>
        <div class="container text-center">
            ...
            <nav id="fh5co-main-nav" role="navigation">
                <ul>
                    <li><a href="<%=request.getContextPath()%>/jsp/index.jsp" class="active">Главная</a></li>
                </ul>
            </nav>
        </div>
    </header>
<center><h3 style="color:red"><%=((String) session.getAttribute("errMessage") == null) ? "" : (String) session.getAttribute("errMessage")%></h3></center>
            ...
            <form name="frm" method="post" action="<%=request.getContextPath()%>/AdminController">
                <fieldset class="container">
                    ...
                    <div class="wrapper">
                        ...
                        <br />
                        <input name="email" id="tbEmail" type="email" class="frm-ctrl tb" spellcheck="false" autocomplete="off" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$" required="true"/>
                    </div>
                    <div class="wrapper">
                        <label for="tbPwd1" class="lbl-tb"><i class="fa fa-unlock fa-fw"></i> Пароль</label>
                        <br />
                        <input name="password" id="tbPwd1" type="password" class="frm-ctrl tb" pattern=".{6,}" required="true" />
                    </div>
                    <div class="wrapper">
